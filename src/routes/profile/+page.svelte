<script>
	...
	onMount(async () => {
		...
		if (user) {
			// Fetch profile details from Firebase Auth
			userPhoto = user.photoURL || 'assets/img/favicon.png';
...
<body id="inner-body" class="g-sidenav-show bg-gray-100">
			...
			>
				...
				<div class="w-100 position-relative p-3">
					<div class="d-flex justify-content-between align-items-end">
						...
						<div class="d-flex align-items-center">
							<a href="javascript:;" class="btn btn-outline-white mb-0 me-1 btn-sm">Billing</a>
							<a href="javascript:;" class="btn btn-outline-white mb-0 btn-sm">Payments</a>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
									<div class="card card-blog card-plain">
										...
										<div class="card-body px-1 pb-0">
											...
											<a href="javascript:;">
												<h5 class="font-weight-bolder">Modern</h5>
											</a>
								...
								<div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
									<div class="card card-blog card-plain">
										...
										<div class="card-body px-1 pb-0">
											...
											<a href="javascript:;">
												<h5 class="font-weight-bolder">Scandinavian</h5>
											</a>
											<p class="mb-4 text-sm">
								...
								<div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
									<div class="card card-blog card-plain">
										...
										<div class="card-body px-1 pb-0">
											...
											<a href="javascript:;">
												<h5 class="font-weight-bolder">Minimalist</h5>
											</a>
											<p class="mb-4 text-sm">
	...
	<script>
		...
		console.log('iconNavbarSidenav:', iconNavbarSidenav);
		console.log('iconSidenav:', iconSidenav);
		console.log('sidenav:', sidenav);
		console.log('innerBody:', innerBody);
		// Add the class name and toggle function setup here
		...
		function toggleSidenav() {
			console.log('Toggling sidenav'); // This should show up if listeners are working
