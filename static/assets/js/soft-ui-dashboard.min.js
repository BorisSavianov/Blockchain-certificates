...
function sidebarType(e) {
	...
	('bg-transparent' != s && 'bg-white' != s) || !a
		? (o = (l = document.querySelector('.navbar-brand-img')).src).includes('logo-ct-dark.png') &&
			((c = o.replace('logo-ct-dark', 'logo-ct')), (l.src = c))
		: (o = (l = document.querySelector('.navbar-brand-img')).src).includes('logo-ct.png') &&
...
document.addEventListener('DOMContentLoaded', function () {
	...
	function toggleSidenav() {
		...
		innerBody.classList.contains(className)
	...
	if (e.getAttribute('checked')) {
		...
		for (L = 0; L < v.length; L++)
			v[L].classList.contains('bg-gray-600') &&
				(v[L].classList.remove('bg-gray-600'), v[L].classList.add('bg-gray-100'));
		...
		for (var L = 0; L < f.length; L++)
			f[L].classList.contains('bg-gray-100') &&
				(f[L].classList.remove('bg-gray-100'), f[L].classList.add('bg-gray-600'));
		...
		e = (e) => {
			new IntersectionObserver(
				(e) => {
					e.forEach((e) => {
						e.isIntersecting &&
							(t(), (e = e.target), (e = document.querySelector(`a[href='#${e.id}']`))) &&
